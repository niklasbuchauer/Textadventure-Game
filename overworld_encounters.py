...
OVERWORLD_ENEMIES = {
	...
	"wild_wolf": {
		...
		"loot": [("wolf_pelt", 0.40), ("raw_meat", 0.30), ("wolf_fang", 0.15), ("wildflower_seed", 0.06)],
		"abilities": ["bite", "howl"],
		"regions": ["forest"],
	},
	"forest_spider": {
		...
		"loot": [("spider_silk", 0.35), ("venom_sac", 0.15), ("mushroom_seed", 0.05)],
		"abilities": ["bite", "web"],
		"regions": ["forest"],
	},
	"wild_boar": {
		...
		"loot": [("raw_meat", 0.50), ("boar_tusk", 0.20), ("leather_scrap", 0.25), ("wheat_seed", 0.07)],
	...
	"swamp_snake": {
		...
		"loot": [("venom_sac", 0.35), ("snake_scale", 0.20), ("strange_herb_seed", 0.06)],
	...
	"bog_shambler": {
		...
		"loot": [("swamp_moss", 0.40), ("bone_fragment", 0.25), ("health_potion", 0.10), ("mushroom_seed", 0.07)],
	...
	"desert_raider": {
		...
		"loot": [("health_potion", 0.20), ("gold_ring", 0.12), ("scimitar", 0.08), ("wheat_seed", 0.05)],
